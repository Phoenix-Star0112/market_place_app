  ...
  return (
    <div className="py-10 page-container max-w-4xl">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-3xl font-bold text-white mb-3">Verification Center</h1>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
        {BENEFITS.map((b) => (
          <div key={b.title} className="bg-neutral-900 rounded-xl border border-neutral-800 p-4 text-center">
            ...
            <div className="space-y-4 mb-6">
              {BUYER_STEPS.map((step, i) => (
                <div key={i} className="flex items-start gap-3">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${step.done ? "bg-green-100" : "bg-neutral-800"}`}>
                    {step.done
      ...
      {/* FAQ */}
      <div className="mt-10 bg-neutral-900 rounded-2xl border border-neutral-800 p-6">

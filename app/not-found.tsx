      ...
      <main className="flex-1 flex items-center justify-center py-24 px-4">
        <div className="text-center max-w-lg w-full">
          ...
          <div className="relative inline-block mb-8">
            <div className="text-[120px] font-black leading-none text-slate-100 dark:text-slate-800 select-none">
              404
            </div>
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-20 h-20 bg-yellow-400 rounded-3xl flex items-center justify-center shadow-lg">
                <svg className="w-10 h-10 text-yellow-900" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-wrap gap-3 justify-center mb-10">
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-yellow-400 text-slate-900 font-semibold hover:bg-yellow-300 transition-colors shadow-sm"
            >
              ← Go Home
            </Link>
            <Link
            ...
            <div className="grid grid-cols-4 gap-3">
              {[
                ...
                <Link
                  key={c.label}
                  href={c.href}
                  className="flex flex-col items-center gap-1.5 p-3 rounded-xl hover:bg-yellow-50 dark:hover:bg-yellow-900/20 hover:border-yellow-200 dark:hover:border-yellow-800 border border-transparent transition-all"
                >
